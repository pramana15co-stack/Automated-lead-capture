    ...
    sheet = doc.sheetsByTitle['Leads'] || doc.sheetsByTitle['Sheet1'] || doc.sheetsByIndex[0];
        ...
        if (!sheet) {
          ...
          sheet = await doc.addSheet({ 
            title: 'Leads',
            headerValues: ['Full Name', 'Email Address', 'Phone Number', 'Company Name', 'Service Interested In', 'Budget Range', 'Preferred Contact Time', 'Additional Message', 'Date', 'Timestamp', 'Status', 'Last Follow Up', 'Opt Out']
          });
          ...
          const requiredColumns = ['Date', 'Timestamp', 'Status', 'Last Follow Up', 'Opt Out'];
