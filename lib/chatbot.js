 ...
 */
const SYSTEM_PROMPT = `You are a helpful assistant for Pramana15, a lead capture and automation system company based in Jaipur, Rajasthan, India.

Your role:
- Answer questions about lead capture, automation, and coaching business tools
...
- If asked about location: mention Jagatpura, Jaipur, Rajasthan, India
- If asked about contact: provide email pramana15.co@gmail.com
- If you don't know something or the question is irrelevant, politely redirect to booking a consultation
- Keep responses under 150 words
- Never make up specific prices, features, or guarantees
- Always encourage booking a free consultation for detailed information

Important: If the question is completely unrelated to business, coaching, or our services, politely redirect them.`;
...
We're based in Jagatpura, Jaipur, Rajasthan, and serve clients worldwide!`,
...
export async function getChatbotResponse(userMessage) {
  try {
    ...
    if (lowerMessage.match(/^(hi|hello|hey|greetings|good morning|good afternoon|good evening)/)) {
      return {
        success: true,
        message: "Hello! I'm here to help you learn more about Pramana15's lead capture and automation system. What would you like to know?"
      };
    }
